const { SlashCommandBuilder, EmbedBuilder,PermissionsBitField,PermissionFlagsBits, ActionRowBuilder, ButtonStyle, ButtonBuilder } = require("discord.js");
...
/*        if (!interaction.member.roles.cache.has(supportRoleID)) {
        ...
        const logsRoomId = ticketDB.get(`LogsRoom_${interaction.guild.id}`);
